...
urlpatterns = [
    ...
    path('<int:project_id>/fin-request', views.financial_request, name="financial_request"),
    path('recruitment/new', views.recruitement_request, name="recruitement_request")
]
